...
const Dashboard = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white overflow-x-hidden">
      <div className="w-full flex flex-col px-2 sm:px-4 lg:px-6 py-4 max-w-[100vw]">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <select className="border rounded-md px-6 py-2" value={selectedYear} onChange={(e) => setSelectedYear(e.target.value)}>
        ...
        <div className="mt-4"><OverviewStats data={getOverviewStats()} /></div>
        <div className="mt-4"><ChartsSection pieData={getPieData()} barData={getBarData()} /></div>
        <div className="mt-4"><PerformanceOverview data={getPerformanceData()} /></div>
